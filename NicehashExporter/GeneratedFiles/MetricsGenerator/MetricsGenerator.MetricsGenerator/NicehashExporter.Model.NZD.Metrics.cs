...
namespace NicehashExporter.Model { public partial class NZD {
...
public static void UpdateMetrics(string prefix, MetricCollection metrics, NZD data, List<string> extraLabels = null) {
if(extraLabels == null) { 
